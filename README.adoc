...
2. Navigate to this repo that you cloned local to you system, and select **cfn/master.yaml**
...
7. Click all checkboxes in the blue **Capabilities** box at the bottom of the page.
+
