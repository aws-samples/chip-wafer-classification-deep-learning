...
image::_images/wafer_ai_better_wafer.png[Better Yields with AWS ML]
...
To ensure the highest possible yields, the foundry will use these classifications to find defect patterns and make adjustments or repairs to wafer manufacturing equipment.
